...
window.onload = function () {
  ...
  var clear_upload_form = function clear_upload_form() {
    photoTitle.value = '';
  ...
  function hideMessage() {
    var from = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'unknown';
  ...
  function showMessage(message, msgType) {
    ...
    var closer = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
...
module.exports = __webpack_require__("./resources/assets/js/entries_form.js");
